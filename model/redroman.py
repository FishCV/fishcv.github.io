...
# python redroman.py train --dataset=\path\to\fish\dataset --weights=coco (or \path\to\weights\file) --logs \path\to\save\logs
# e.g. python redroman.py train --dataset=..\..\datasets\redroman\ --weights=coco

# [ii.] Resume training a model from previous weights
# python redroman.py train --dataset=\path\to\fish\dataset --weights=last
# e.g. python redroman.py train --dataset=..\..\datasets\redroman\ --weights=last
# e.g. python redroman.py train --dataset=..\..\datasets\redroman\ --weights=..\..\weights\redroman\mask_rcnn_redroman.h5
